...
interface ExportOptions {
  ...
  documents: any[];
  frameworks: any[];
  aiAnalysis?: any; // AI-generated insights from OpenAI
}
      ...
      <body>
        ...
        <div class="section">
          ...
          <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 20px; border-radius: 12px; margin-bottom: 30px;">
            <h3 style="color: white; margin-top: 0;">Executive AI Insights</h3>
            <div style="background: rgba(255,255,255,0.1); padding: 15px; border-radius: 8px; margin: 15px 0;">
              ${aiAnalysis.analysis ? aiAnalysis.analysis.replace(/\n/g, '<br>') : 'AI analysis in progress...'}
            </div>
            ...
            ` : ''}
            <div style="text-align: right; margin-top: 15px; font-size: 12px; opacity: 0.8;">
              Compliance Score: ${aiAnalysis.complianceScore || 'Calculating...'}% | Generated by OpenAI GPT-4
            </div>
          </div>
        </div>
        ` : ''}
